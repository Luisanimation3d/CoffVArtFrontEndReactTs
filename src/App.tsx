...
const SuppliesEdit = lazy(() => import('./Pages/Supplies/EditSupply.tsx'));
                            ...
                            <Routes>
                                ...
                                <Route element={<ProtectedRoutes/>}>
                                    <Route path={'/admin/'} element={
                                        ...
                                        <Route path={'coustomers/create'} element={
                                            <Suspense fallback={<h1>Cargando el componente de coustomers</h1>}>
                                                <CreateCoustomer/>
                                            </Suspense>
                                        }/>
                                        ...
                                        <Route path={'users/create'} element={
                                          ...
                                          <Route path={'Supplys/create'} element={
                                            <Suspense fallback={<h1>Cargando el componente de insumos</h1>}>
                                                <SupplyCreate/>
                                            </Suspense>
                                        }/>
                                        <Route path={'Products/create'} element={
                                         ...
                                         <Route path={'Supplys/edit/:id'} element={
                                            <Suspense fallback={<h1>Cargando el componente de insumos</h1>}>
                                                <SuppliesEdit/>
                                            </Suspense>
