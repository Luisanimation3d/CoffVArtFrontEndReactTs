          ...
          <MDBCol lg="8">
            <MDBCard className="mb-4">
              <MDBCardBody>
                ...
                <MDBRow>
                  <MDBCol sm="3">
                    <MDBCardText>Tipo de documento</MDBCardText>
                  </MDBCol>
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">{userData?.documentType}</MDBCardText>
                  </MDBCol>
                </MDBRow>
                <hr />
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">{userData?.document}</MDBCardText>
                  </MDBCol>
                </MDBRow>
                <hr />
                <MDBRow>
