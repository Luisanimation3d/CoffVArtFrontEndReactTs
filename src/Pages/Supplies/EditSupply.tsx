...
export const SuppliesEdit = () => {
	...
	const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!formData.description || formData.description.trim().length < 5 || !/^[a-zA-ZÁÉÍÓÚáéíóú\s()ñ]+$/.test(formData.description)){
            mensajeError = {...mensajeError, description: 'La descripción es requeridas'}
        }
