...
const RolesEditStepTwo = ({ changeStep, valueForm, setValueForm }: {
    ...
    useEffect(() => {
        ...
        // const newPermissionsAlreadySelected = permissionsAlreadySelected?.map((permission: any) => {
        //     console.log(valueForm)
        //     const privilege = permission?.privileges?.find((privilege: any) => {
        //         console.log(privilege, 'privilege')
        //         console.log(valueForm?.permissions, 'valueForm?.permissions')
        //         return privilege?.id === valueForm?.permissions?.find((permissionSelected: any) => permissionSelected === privilege?.id)
        //     })
        //     return {
        //         privilege,
        //         permission
